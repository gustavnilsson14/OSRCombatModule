function getBattleFeatures() {
  return {
    any: [
      ...
      {
        Name: "Fog",
        Effects: new GetAllArray(["5 Tiles In center", "Ranged damage passing the fog deals no damage dice"]),
      },
      {
        Name: "Mutagen spores",
        Effects: new GetAllArray([
      ...
      {
        Name: "Pink asphalt",
        Effects: new GetAllArray(["5 Tiles In center", "Starting turn on the asphalt suffer damage", "Damage is 2d6 light"]),
      },
      {
        Name: "Stinkmud",
        Effects: new GetAllArray([
    ...
    wilderness: [
      {
        ...
        Effects: new GetAllArray(["3 Tiles", "Cut and light destroys the bridge", "Falling ejects from combat, and suffer injury"]),
      },
      {
        Name: "Pit",
        Effects: new GetAllArray(["A fall deals 3d6 smash damage", "Getting out requires tactical action"]),
      },
      {
        Name: "Brush",
        Effects: new GetAllArray(["Hide tactical action is automatic if using stand ground"]),
      },
      {
        Name: "Rain",
        Effects: new GetAllArray(["Global", "Light deals no damage", "No fire is possible"]),
      },
      {
        Name: "Brook",
        Effects: new GetAllArray(["2 Tiles", "Stops charging or retreating"]),
      },
      {
        Name: "Mire",
        Effects: new GetAllArray(["3 Tiles", "Stops charging or retreating", "Requires tactical action to move if round is started in mire"]),
      },
      {
        Name: "Slippery mud",
        Effects: new GetAllArray(["2 Tiles", "Charging or retreating must succeed with DEX, or to fall, and not be able to move until next round"]),
      },
      {
        Name: "Lay line",
        Effects: new GetAllArray([
      ...
      {
        Name: "Cliff cover",
        Effects: new GetAllArray(["If stand ground, gain 2 armor versus ranged damage"]),
      },
      {
        Name: "Poisonous plants",
        Effects: new GetAllArray([
          "Once per turn, if on the same tile, take 1d8 ooze damage",
          "If starting round on the tile, on failed WIL, cannot take TA",
        ]),
      },
      {
        Name: "Small shanty",
        Effects: new GetAllArray(["2 Tiles", "Garrisson with TA", "No ranged skill die"]),
      },
      {
        Name: "Mantis hive",
        Effects: new GetAllArray([
          ...
          "3 Tiles when roused",
          "Deals 1d8 stab, pain damage at start of each turn to combatans in the tiles",
        ]),
      },
      {
        Name: "Stampede",
    ...
    ruins: [
      {
        Name: "Fire barrel",
        Effects: new GetAllArray(["Can be toppled in melee", "When toppled, causes a fire the same, or an adjacent tile"]),
      },
      {
        ...
        Effects: new GetAllArray([
          ...
          "Deals 2d10 blast damage to own tile, and adjacent. Also knockback on failed STR",
        ]),
      },
      {
    ...
    cave: [
      ...
      {
        Name: "Rocky rubble",
        Effects: new GetAllArray(["3 Tiles", "If charging, or retreating, failed STR will stop movement"]),
      },
      {
    ...
    interior: [
      ...
      },
      {
        ...
        Effects: new GetAllArray(["Closes a door "]),
      },
      {
